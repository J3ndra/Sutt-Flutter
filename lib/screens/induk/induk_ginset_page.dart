...
import 'package:sutt/screens/induk/induk_bay_page.dart';

class IndukGinsetPage extends StatefulWidget {
  const IndukGinsetPage({super.key, required this.city, required this.kw});

  final String city;
  final String kw;

  static Page<void> page() =>
      const MaterialPage<void>(child: IndukGinsetPage(city: '', kw: ''));

  @override
  State<IndukGinsetPage> createState() => _IndukGinsetPageState();
}

class _IndukGinsetPageState extends State<IndukGinsetPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('Induk - Ginset'),
          titleSpacing: 0,
          leading: InkWell(
            key: const Key('indukGinsetPage_back_iconButton'),
            child: Icon(
              Icons.arrow_back,
