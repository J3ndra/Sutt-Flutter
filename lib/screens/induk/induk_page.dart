...
import 'package:sutt/screens/induk/induk_ginset_page.dart';

class IndukPage extends StatelessWidget {
  const IndukPage({super.key});

  static Page<void> page() => const MaterialPage<void>(child: IndukPage());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        titleSpacing: 0,
        leading: InkWell(
          key: const Key('indukPage_back_iconButton'),
          child: Icon(
            Icons.arrow_back,
